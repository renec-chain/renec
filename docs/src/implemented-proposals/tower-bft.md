...
This design describes Renec's _Tower BFT_ algorithm. It addresses the following problems:
...
The Renec cluster generates a source of time via a Verifiable Delay Function we are calling [Proof of History](../cluster/synchronization.md).

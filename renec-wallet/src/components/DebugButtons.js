...
export default function DebugButtons() {
  ...
  function requestAirdrop() {
    callAsync(
      wallet.connection.requestAirdrop(wallet.publicKey, 20 * LAMPORTS_PER_SOL),
      {
        onSuccess: async () => {
          await sleep(5000);
        ...
        successMessage:
          'Success! Please wait up to 30 seconds for the RENEC tokens to appear in your wallet.',
      },
    );
  }

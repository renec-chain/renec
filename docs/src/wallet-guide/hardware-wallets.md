---
title: Using Hardware Wallets on the Renec CLI
---
...
Renec defines a keypair URL format to uniquely locate any Renec keypair on a
...
`DERVIATION_PATH` is used to navigate to Renec keys within your hardware wallet.

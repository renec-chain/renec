...
Connection is used to interact with the [Renec JSON RPC](https://docs.renec.foundation/developing/clients/jsonrpc-api). You can use Connection to confirm transactions, get account info, and more.
...
// Airdrop RENEC for paying transactions

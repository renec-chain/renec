...
renec-keygen new -o "$dummy_keypair" --no-passphrase --force --silent
...
renec-keygen new -o "$online_system_account_keypair" --no-passphrase --force --silent
renec-keygen new -o "$online_nonce_account_keypair" --no-passphrase --force --silent

online_system_account_pubkey="$(renec-keygen pubkey $online_system_account_keypair)"
nonce_account_pubkey="$(renec-keygen pubkey $online_nonce_account_keypair)"
...
renec-keygen new -o "$offline_system_account_keypair" --no-passphrase --force --silent
renec-keygen new -o "$offline_staker_keypair" --no-passphrase --force --silent
renec-keygen new -o "$offline_withdrawer_keypair" --no-passphrase --force --silent
renec-keygen new -o "$offline_custodian_keypair" --no-passphrase --force --silent

offline_system_account_pubkey="$(renec-keygen pubkey $offline_system_account_keypair)"
offline_withdrawer_pubkey="$(renec-keygen pubkey $offline_withdrawer_keypair)"
offline_staker_pubkey="$(renec-keygen pubkey $offline_staker_keypair)"
offline_custodian_pubkey="$(renec-keygen pubkey $offline_custodian_keypair)"
...
renec-keygen new -o "$stake_account_keypair" --no-passphrase --force --silent
stake_account_address="$(renec-keygen pubkey $stake_account_keypair)"
...
renec-keygen new -o $split_stake_account_keypair --no-passphrase --force --silent
split_stake_account_address=$(renec-keygen pubkey $split_stake_account_keypair)
